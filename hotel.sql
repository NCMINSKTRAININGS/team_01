...
CREATE TABLE IF NOT EXISTS `hotel`.`status` (
  ...
  `statusEn` VARCHAR(45) NULL DEFAULT NULL,
  `statusRu` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `hotel`.`user_room` (
  ...
  `check-in_date` TIMESTAMP(10) NULL DEFAULT NULL,
  `check-out_date` TIMESTAMP(10) NULL DEFAULT NULL,
